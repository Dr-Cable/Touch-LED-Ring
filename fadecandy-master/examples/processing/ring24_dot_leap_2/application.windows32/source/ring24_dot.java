...
public class ring24_dot extends PApplet {
...
public void setup()
{
  ...
  opc.ledRing(0, 24, width/2, height/2, width*0.18f, 0);
}
...
public class OPC
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "ring24_dot" };
    if (passedArgs != null) {
